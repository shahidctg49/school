				...
				<div class="x_panel">
					...
					<div class="x_content">
                        ...
                        <?php
							$id=$_GET['id'];    
							$w['id']=$id;
							$user_data=$mysqli->common_select_single('groups','*',$w)['selectdata'];
						?>
						<br />
						...
						<?php
							if($_POST){
								...
								$upwhere['id']=$id;
							  $result=$mysqli->common_update('groups',$_POST,$upwhere);
							  if($result['error']){
								$_SESSION['class']="danger";
								$_SESSION['msg']=$result['error'];
								echo "<script> location.replace('$base_url/groups_update.php?id=$id')</script>";
							  }else{
